...
namespace D2PartyTime
{
    class D2Window : ID2Window
    {
        ...
        private D2HostPanel targetControl;
        private Form underlayForm;
        private D2OverlayWindow overlayForm;
        ...
        private void OnParentMove(object sender, EventArgs e) // note
        {
        ...
        public void MouseMove(int x, int y) // note
        {
        ...
        void ID2Window.Click(int x, int y) // note
        {
            LeftMouseDown(x, y);
            LeftMouseUp(x, y);
        }
        ...
        bool ID2Window .IsActive()
        {
            return this.isActive;
        }

        private System.Windows.Forms.KeyEventHandler keyDown = delegate { };
        event System.Windows.Forms.KeyEventHandler ID2Window.KeyDown
        {
            add
            {
        ...
        event System.Windows.Forms.KeyEventHandler ID2Window.KeyUp
        {
            add
            {
