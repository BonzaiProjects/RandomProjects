...
{
    class DiabloWindow : IDiabloWindow
    {
        #region Constants
        ...
        public DiabloWindow(Form mainWindow, DiabloHostPanel overlayControl, IntPtr diablo2Handle)
        {
            ...
            var pic = Imaging.CreateBitmapSourceFromHBitmap((new Bitmap(D2PartyTime.Properties.Resources.D2Cursor)).GetHbitmap(), IntPtr.Zero, Int32Rect.Empty, BitmapSizeOptions.FromEmptyOptions());
