...
namespace OneForAll
{
    public class DiabloWindow
    {
        ...
        public DiabloHostPanel targetControl;
        public Form underlayForm;
        public OverlayWindow overlayForm;
        ...
        private void OnParentMove(object sender, EventArgs e)
        {
            ...
            underlayForm.Left = underlayLocation.X + targetControl.Location.X;
            underlayForm.Top = underlayLocation.Y + targetControl.Location.Y;
